...
class OnlineFleetBattleGame extends ApplicationAdapter implements InputProcessor {
...
//            }
    ...
    @Override
    public void create () {
        mGoogleApiClient = OnlineGameLauncher.getmGoogleApiClient();
...
//                }
    ...
    public boolean touchUp(int screenX, int screenY, int pointer, int button) {
        ...
        if(state==1) {
            ...
            //OnlineGameLauncher ogl = new OnlineGameLauncher();
